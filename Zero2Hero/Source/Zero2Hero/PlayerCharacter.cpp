...
{
	//GEngine->AddOnScreenDebugMessage(-1, 15.0f, FColor::Green, TEXT("Overlap Player"));
	if (OtherActor != this)
	{

		//GEngine->AddOnScreenDebugMessage(-1, 15.0f, FColor::Green, FString::Printf(TEXT("%f"), (OverlappedComponent->ComponentHasTag("MeleeZone"))));
